...
import com.indiv.neilly.world.gen.generators.WorldGenMapleTree;
...
public class BlockSaplings extends BlockBush implements IGrowable, IMetaName, IHasModel
{
    ...
    public BlockSaplings(String name)
    {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumWoodHandler.EnumType.MAPLE).withProperty(STAGE, Integer.valueOf(0)));
    ...
    {
        return this.getDefaultState().withProperty(VARIANT, EnumWoodHandler.EnumType.byMetadata(meta & 1)).withProperty(STAGE, Integer.valueOf((meta & 8) >> 3));
    }
    ...
    public void registerModels()
    {
        ...
        {
            Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "sapling_" + EnumWoodHandler.EnumType.values()[i].getName(), "inventory");
        }
    }
