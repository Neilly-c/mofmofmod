...
public class EnchantSweetDream extends Enchantment implements INewEnchantment{
    public EnchantSweetDream(String name, Rarity rarityIn, EnumEnchantmentType typeIn, EntityEquipmentSlot[] slots) {
