...
public class EnchantWander extends Enchantment implements INewEnchantment{
    public EnchantWander(String name, Rarity rarityIn, EnumEnchantmentType typeIn, EntityEquipmentSlot[] slots) {
